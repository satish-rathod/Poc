import AgoraManagerStreamMedia from "../stream_media/agora_manager_stream_media.js";
...
window.onload = async () => {
  ...
  const agoraManager = await AgoraManagerStreamMedia(
  ...
  document.getElementById("streamMedia").onclick = async function () {
    agoraManager.streamMedia(channelParameters);
  };
  if(product == "live")
  {
    createToggleSwitch();
