import AgoraManagerAINoiseSuppression from "./agora_manager_ai_noise_suppression.js";
...
window.onload = async () => {
  ...
  const agoraManager = await AgoraManagerAINoiseSuppression(
  ...
  document.getElementById("aiNoiseSuppression").onclick = async function () {
    agoraManager.enableAIDenoiser(channelParameters);
  };
};
